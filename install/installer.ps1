...
function Install-SvmPackage
{
  ...
  $zipFolderToExtract = [System.IO.Path]::Combine($unzipFolder, 'scriptcs-svm-0.3.1', 'src', 'bin')
  ...
  $zipFolderToExtract = [System.IO.Path]::Combine($unzipFolder, 'scriptcs-svm-0.3.1', 'src', 'shims')
...
$url          = "https://github.com/paulbouwer/scriptcs-svm/archive/v0.3.1.zip"
